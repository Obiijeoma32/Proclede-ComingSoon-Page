...
function ComingSoon() {
  ...
  const calculateCountdown = () => {
    const targetDate = new Date("2024-01-30T23:59:59Z"); // ISO date format
  ...
  return (
    <>
      <div className="w-full  bg-fixed min-h-screen bg-no-repeat flex justify-center items-center object-cover bg-center bg-cover bg-[url('./Components/Resource.png')]">
        <div className="w-[85%] flex justify-between items-center flex-col ">
          <div className="top-[40px] left-[40px] absolute ">
